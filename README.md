...
Tools
Python, pandas, Google Sheets, CSV dataset

Results
The cleaned dataset had valid ages and scores within a realistic range, no duplicates, and was ready for accurate analysis and visualization.

Learning
I learned that data quality matters more than model complexity, and even small errors in data can significantly alter the results.
